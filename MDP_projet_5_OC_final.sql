...
-- Started on 2020-09-07 21:08:36
...
--
-- TOC entry 207 (class 1259 OID 18544)
-- Name: aide_memoire_aide_memoire_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.aide_memoire_aide_memoire_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.aide_memoire_aide_memoire_id_seq OWNER TO postgres;

--
-- TOC entry 2937 (class 0 OID 0)
-- Dependencies: 207
-- Name: aide_memoire_aide_memoire_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.aide_memoire_aide_memoire_id_seq OWNED BY public.aide_memoire.aide_memoire_id;
...
CREATE TABLE public.client (
    ...
    numero_de_telephone character varying(14) NOT NULL,
...
--
-- TOC entry 215 (class 1259 OID 18578)
...
--
-- TOC entry 218 (class 1259 OID 18588)
...
--
-- TOC entry 217 (class 1259 OID 18586)
-- Name: commande__numero_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.commande__numero_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.commande__numero_seq OWNER TO postgres;

--
-- TOC entry 2939 (class 0 OID 0)
-- Dependencies: 217
-- Name: commande__numero_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.commande__numero_seq OWNED BY public.commande.numero;


--
-- TOC entry 220 (class 1259 OID 18602)
...
--
-- TOC entry 219 (class 1259 OID 18597)
-- Name: commande_restaurant; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.commande_restaurant (
    numero integer NOT NULL,
    restaurant_id integer NOT NULL
);


ALTER TABLE public.commande_restaurant OWNER TO postgres;

--
-- TOC entry 203 (class 1259 OID 18525)
...
--
-- TOC entry 202 (class 1259 OID 18523)
...
-- Name: ligne_de_stock; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ligne_de_stock (
    restaurant_id integer NOT NULL,
    ingredient_id integer NOT NULL,
...
ALTER TABLE public.ligne_de_stock OWNER TO postgres;

--
-- TOC entry 210 (class 1259 OID 18554)
...
--
-- TOC entry 209 (class 1259 OID 18552)
...
ALTER TABLE public.personnel_personnel_id_seq OWNER TO postgres;
...
--
-- TOC entry 205 (class 1259 OID 18533)
...
--
-- TOC entry 206 (class 1259 OID 18539)
-- Name: produit_ingredients; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.produit_ingredients (
    produit_id integer NOT NULL,
    ingredient_id integer NOT NULL,
    quantite integer NOT NULL
);
...
ALTER TABLE public.produit_ingredients OWNER TO postgres;

--
-- TOC entry 204 (class 1259 OID 18531)
...
CREATE TABLE public.restaurant (
    ...
    ville character varying(50) NOT NULL,
    pays character varying(50) NOT NULL,
    numero_de_tel character varying(14) NOT NULL,
    mail character varying(50) NOT NULL,
    mot_de_passe character varying(30) NOT NULL
);
...
--
-- TOC entry 214 (class 1259 OID 18573)
-- Name: restaurant_personnel; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.restaurant_personnel (
    personnel_id integer NOT NULL,
    restaurant_id integer NOT NULL
);


ALTER TABLE public.restaurant_personnel OWNER TO postgres;

--
-- TOC entry 211 (class 1259 OID 18560)
...
--
-- TOC entry 2746 (class 2604 OID 18549)
-- Name: aide_memoire aide_memoire_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.aide_memoire ALTER COLUMN aide_memoire_id SET DEFAULT nextval('public.aide_memoire_aide_memoire_id_seq'::regclass);


--
-- TOC entry 2749 (class 2604 OID 18583)
...
--
-- TOC entry 2750 (class 2604 OID 18591)
-- Name: commande numero; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande ALTER COLUMN numero SET DEFAULT nextval('public.commande__numero_seq'::regclass);


--
-- TOC entry 2744 (class 2604 OID 18528)
...
--
-- TOC entry 2747 (class 2604 OID 18557)
...
--
-- TOC entry 2745 (class 2604 OID 18536)
...
--
-- TOC entry 2748 (class 2604 OID 18565)
...
--
-- TOC entry 2758 (class 2606 OID 18551)
-- Name: aide_memoire aide_memoire_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.aide_memoire
    ADD CONSTRAINT aide_memoire_pk PRIMARY KEY (aide_memoire_id);


--
-- TOC entry 2768 (class 2606 OID 18585)
...
--
-- TOC entry 2770 (class 2606 OID 18596)
-- Name: commande commande__pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande
    ADD CONSTRAINT commande__pk PRIMARY KEY (numero);


--
-- TOC entry 2774 (class 2606 OID 18606)
...
ALTER TABLE ONLY public.commande_produit
    ADD CONSTRAINT commande_produit_pk PRIMARY KEY (produit_id, numero);


--
-- TOC entry 2772 (class 2606 OID 18601)
-- Name: commande_restaurant commande_restaurant_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande_restaurant
    ADD CONSTRAINT commande_restaurant_pk PRIMARY KEY (numero, restaurant_id);


--
-- TOC entry 2752 (class 2606 OID 18530)
...
--
-- TOC entry 2764 (class 2606 OID 18572)
-- Name: ligne_de_stock ligne_de_stock_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ligne_de_stock
    ADD CONSTRAINT ligne_de_stock_pk PRIMARY KEY (restaurant_id, ingredient_id);


--
-- TOC entry 2760 (class 2606 OID 18559)
-- Name: personnel personnel_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: produit_ingredients produit_ingredients_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produit_ingredients
    ADD CONSTRAINT produit_ingredients_pk PRIMARY KEY (produit_id, ingredient_id);
...
--
-- TOC entry 2766 (class 2606 OID 18577)
-- Name: restaurant_personnel restaurant_personnel_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.restaurant_personnel
    ADD CONSTRAINT restaurant_personnel_pk PRIMARY KEY (personnel_id, restaurant_id);


--
-- TOC entry 2762 (class 2606 OID 18567)
...
--
-- TOC entry 2782 (class 2606 OID 18652)
-- Name: commande client_commande__fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande
    ADD CONSTRAINT client_commande__fk FOREIGN KEY (client_id) REFERENCES public.client(client_id);


--
-- TOC entry 2786 (class 2606 OID 18657)
-- Name: commande_produit commande__commande_produit_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande_produit
    ADD CONSTRAINT commande__commande_produit_fk FOREIGN KEY (numero) REFERENCES public.commande(numero);


--
-- TOC entry 2784 (class 2606 OID 18662)
-- Name: commande_restaurant commande__commande_restaurant_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande_restaurant
    ADD CONSTRAINT commande__commande_restaurant_fk FOREIGN KEY (numero) REFERENCES public.commande(numero);


--
-- TOC entry 2778 (class 2606 OID 18607)
-- Name: ligne_de_stock ingredients_ligne_de_stock_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ligne_de_stock
    ADD CONSTRAINT ingredients_ligne_de_stock_fk FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(ingredient_id);


--
-- TOC entry 2775 (class 2606 OID 18612)
-- Name: produit_ingredients ingredients_produit_ingredients_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produit_ingredients
    ADD CONSTRAINT ingredients_produit_ingredients_fk FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(ingredient_id);


--
-- TOC entry 2780 (class 2606 OID 18632)
-- Name: restaurant_personnel personnel_restaurant_personnel_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.restaurant_personnel
    ADD CONSTRAINT personnel_restaurant_personnel_fk FOREIGN KEY (personnel_id) REFERENCES public.personnel(personnel_id);


--
-- TOC entry 2777 (class 2606 OID 18622)
-- Name: aide_memoire produit_aide_memoire_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.aide_memoire
    ADD CONSTRAINT produit_aide_memoire_fk FOREIGN KEY (produit_id) REFERENCES public.produit(produit_id);


--
-- TOC entry 2785 (class 2606 OID 18617)
-- Name: commande_produit produit_commande_produit_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande_produit
    ADD CONSTRAINT produit_commande_produit_fk FOREIGN KEY (produit_id) REFERENCES public.produit(produit_id);


--
-- TOC entry 2776 (class 2606 OID 18627)
-- Name: produit_ingredients produit_produit_ingredients_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produit_ingredients
    ADD CONSTRAINT produit_produit_ingredients_fk FOREIGN KEY (produit_id) REFERENCES public.produit(produit_id);


--
-- TOC entry 2783 (class 2606 OID 18647)
-- Name: commande_restaurant restaurant_commande_restaurant_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.commande_restaurant
    ADD CONSTRAINT restaurant_commande_restaurant_fk FOREIGN KEY (restaurant_id) REFERENCES public.restaurant(restaurant_id);


--
-- TOC entry 2779 (class 2606 OID 18642)
-- Name: ligne_de_stock restaurant_ligne_de_stock_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ligne_de_stock
    ADD CONSTRAINT restaurant_ligne_de_stock_fk FOREIGN KEY (restaurant_id) REFERENCES public.restaurant(restaurant_id);


--
-- TOC entry 2781 (class 2606 OID 18637)
-- Name: restaurant_personnel restaurant_restaurant_personnel_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.restaurant_personnel
    ADD CONSTRAINT restaurant_restaurant_personnel_fk FOREIGN KEY (restaurant_id) REFERENCES public.restaurant(restaurant_id);


-- Completed on 2020-09-07 21:08:37
